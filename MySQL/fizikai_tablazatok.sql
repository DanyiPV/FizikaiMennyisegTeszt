...
(49, 'Keringési / körül fordulási idő', 'T', 'Egy teljes keringéshez /körül forduláshozszükséges idő', 'secundum', 6),
...
(66, 'hőmérsékletváltozás', '`Deltat`,`DeltaT`', 't<sub>2</sub>-t<sub>1</sub>`-=T<sub>2</sub>-T<sub>1</sub>', '°C, K', 7),
